  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 text-center sticky top-8">
              ...
              <button className="w-full bg-slate-900 text-white py-3 rounded-xl font-bold shadow-md hover:bg-primary transition">
                View Full Wallet
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
              <h3 className="text-lg font-bold text-slate-900 mb-4">Announcement</h3>
              <div
                className="p-4 rounded-xl"
                style={{
                  background: 'linear-gradient(135deg, #f5f3ff 0%, #fef2f2 100%)'
                }}
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 mb-1">Hackathon Season is here!</h4>
                    <p className="text-slate-600 text-sm">
                      Browse 40+ new tasks posted by student teams needing help this week.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
              <h3 className="text-xl font-bold text-slate-900 mb-6 flex items-center gap-2">
                <TrendingUp className="text-primary" /> Admin Activity
              </h3>
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-slate-50 rounded-xl text-center">
                  <p className="text-3xl font-extrabold text-primary">12</p>
                  <p className="text-slate-500 text-sm">Users Managed</p>
                </div>
                <div className="p-4 bg-slate-50 rounded-xl text-center">
                  <p className="text-3xl font-extrabold text-primary">48</p>
                  <p className="text-slate-500 text-sm">Tasks Reviewed</p>
                </div>
                <div className="p-4 bg-slate-50 rounded-xl text-center">
                  <p className="text-3xl font-extrabold text-primary">5</p>
                  <p className="text-slate-500 text-sm">Reports Resolved</p>
                </div>
                <div className="p-4 bg-slate-50 rounded-xl text-center">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-red-200">
              ...
              <button
                className="px-4 py-2 bg-red-50 text-red-600 border border-red-200 rounded-lg font-bold hover:bg-red-100 transition text-sm"
              >
        ...
        {success && (
          <div className="fixed bottom-6 right-6 bg-green-600 text-white px-6 py-3 rounded-xl shadow-lg flex items-center gap-2 animate-bounce">
